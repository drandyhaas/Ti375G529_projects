...
module edb_top (
    ...
    input  la0_clk,
    input  la0_rstn,
    input  la0_DDR_ATYPE_0,
    input  [7:0] la0_DDR_AID_0,
    input  [31:0] la0_DDR_AADDR_0,
    input  [2:0] la0_DDR_ASIZE_0,
    input  [7:0] la0_DDR_ALEN_0,
    input  [1:0] la0_DDR_ABURST_0,
    input  la0_DDR_AVALID_0,
    input  la0_DDR_AREADY_0,
    input  [31:0] la0_DDR_WDATA_0,
    input  [31:0] la0_DDR_WDATA_1,
    input  [31:0] la0_DDR_WDATA_2,
    input  [31:0] la0_DDR_WDATA_3,
    input  [31:0] la0_DDR_WDATA_4,
    input  [31:0] la0_DDR_WDATA_5,
    input  [31:0] la0_DDR_WDATA_6,
    input  [31:0] la0_DDR_WDATA_7,
    input  la0_DDR_WVALID_0,
    input  la0_DDR_WREADY_0,
    input  la0_DDR_WLAST_0,
    input  [31:0] la0_DDR_WSTRB_0,
    input  [7:0] la0_DDR_BID_0,
    input  la0_DDR_BVALID_0,
    input  la0_DDR_BREADY_0,
    input  [7:0] la0_DDR_RID_0,
    input  [31:0] la0_DDR_RDATA_0,
    input  [31:0] la0_DDR_RDATA_1,
    input  [31:0] la0_DDR_RDATA_2,
    input  [31:0] la0_DDR_RDATA_3,
    input  [31:0] la0_DDR_RDATA_4,
    input  [31:0] la0_DDR_RDATA_5,
    input  [31:0] la0_DDR_RDATA_6,
    input  [31:0] la0_DDR_RDATA_7,
    input  [1:0] la0_DDR_RRESP_0,
    input  la0_DDR_RVALID_0,
    input  la0_DDR_RREADY_0,
    input  la0_DDR_RLAST_0,
    input  [1:0] la0_DDR_ALOCK_0,
    input  [7:0] la0_DDR_WID_0,
    input  la0_TRIG,
    input  [3:0] la0_STATE,
    input  [31:0] la0_PATTERN,
    input  [3:0] la0_PATTERN_NUM,
    input  [15:0] la0_OUT_PATTERN,
    input  la0_PATTERN_DONE,
    input  [6:0] la0_CURRENT_PATTERN,
    input  la0_START,
    input  [63:0] la0_Timer_counter,
    input  [7:0] la0_WR_Counte,
    input  [63:0] la0_total_len,
    input  [32:0] la0_LOOP_N,
    input  [127:0] la0_lfsr1,
    input  la0_ERROR,
    input  la0_ddr_rst_done,
    input  la0_pause,
    input  vio0_clk,
    input  [63:0] vio0_Total_ALEN,
    input  [63:0] vio0_Cycle_Counter,
    input  vio0_Test_Done,
    input  [31:0] vio0_Band_Width_MBs,
    input  vio0_ERROR,
    output [31:0] vio0_LOOP_N,
    output [15:0] vio0_PATTERN,
    output [3:0] vio0_PATTERN_DEPTH,
    output [7:0] vio0_PATTERN_LEN0,
    output [7:0] vio0_PATTERN_LEN1,
    output [7:0] vio0_PATTERN_LEN2,
    output [7:0] vio0_PATTERN_LEN3,
    output [7:0] vio0_PATTERN_LEN4,
    output [7:0] vio0_PATTERN_LEN5,
    output [7:0] vio0_PATTERN_LEN6,
    output [7:0] vio0_PATTERN_LEN7,
    output [7:0] vio0_PATTERN_LEN8,
    output [7:0] vio0_PATTERN_LEN9,
    output [7:0] vio0_PATTERN_LEN10,
    output [7:0] vio0_PATTERN_LEN11,
    output [7:0] vio0_PATTERN_LEN12,
    output [7:0] vio0_PATTERN_LEN13,
    output [7:0] vio0_PATTERN_LEN14,
    output [7:0] vio0_PATTERN_LEN15,
    output [31:0] vio0_PATTERN_ADDR0,
    output [31:0] vio0_PATTERN_ADDR1,
    output [31:0] vio0_PATTERN_ADDR2,
    output [31:0] vio0_PATTERN_ADDR3,
    output [31:0] vio0_PATTERN_ADDR4,
    output [31:0] vio0_PATTERN_ADDR5,
    output [31:0] vio0_PATTERN_ADDR6,
    output [31:0] vio0_PATTERN_ADDR7,
    output [31:0] vio0_PATTERN_ADDR8,
    output [31:0] vio0_PATTERN_ADDR9,
    output [31:0] vio0_PATTERN_ADDR10,
    output [31:0] vio0_PATTERN_ADDR11,
    output [31:0] vio0_PATTERN_ADDR12,
    output [31:0] vio0_PATTERN_ADDR13,
    output [31:0] vio0_PATTERN_ADDR14,
    output [31:0] vio0_PATTERN_ADDR15,
    output vio0_Reset,
    output vio0_Pause
);
    ...
    edb_la_top #(
        ...
        .TRIGOUT_EN         ( 0 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h03c740c20ca94ac2b1ceced47500d365 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
        ...
        .trig_out_ack           ( 1'b0 ),
        .probe0                 ( la0_rstn ),
        .probe1                 ( la0_DDR_ATYPE_0 ),
        .probe2                 ( la0_DDR_AID_0 ),
        .probe3                 ( la0_DDR_AADDR_0 ),
        .probe4                 ( la0_DDR_ASIZE_0 ),
        .probe5                 ( la0_DDR_ALEN_0 ),
        .probe6                 ( la0_DDR_ABURST_0 ),
        .probe7                 ( la0_DDR_AVALID_0 ),
        .probe8                 ( la0_DDR_AREADY_0 ),
        .probe9                 ( la0_DDR_WDATA_0 ),
        .probe10                    ( la0_DDR_WDATA_1 ),
        .probe11                    ( la0_DDR_WDATA_2 ),
        .probe12                    ( la0_DDR_WDATA_3 ),
        .probe13                    ( la0_DDR_WDATA_4 ),
        .probe14                    ( la0_DDR_WDATA_5 ),
        .probe15                    ( la0_DDR_WDATA_6 ),
        .probe16                    ( la0_DDR_WDATA_7 ),
        .probe17                    ( la0_DDR_WVALID_0 ),
        .probe18                    ( la0_DDR_WREADY_0 ),
        .probe19                    ( la0_DDR_WLAST_0 ),
        .probe20                    ( la0_DDR_WSTRB_0 ),
        .probe21                    ( la0_DDR_BID_0 ),
        .probe22                    ( la0_DDR_BVALID_0 ),
        .probe23                    ( la0_DDR_BREADY_0 ),
        .probe24                    ( la0_DDR_RID_0 ),
        .probe25                    ( la0_DDR_RDATA_0 ),
        .probe26                    ( la0_DDR_RDATA_1 ),
        .probe27                    ( la0_DDR_RDATA_2 ),
        .probe28                    ( la0_DDR_RDATA_3 ),
        .probe29                    ( la0_DDR_RDATA_4 ),
        .probe30                    ( la0_DDR_RDATA_5 ),
        .probe31                    ( la0_DDR_RDATA_6 ),
        .probe32                    ( la0_DDR_RDATA_7 ),
        .probe33                    ( la0_DDR_RRESP_0 ),
        .probe34                    ( la0_DDR_RVALID_0 ),
        .probe35                    ( la0_DDR_RREADY_0 ),
        .probe36                    ( la0_DDR_RLAST_0 ),
        .probe37                    ( la0_DDR_ALOCK_0 ),
        .probe38                    ( la0_DDR_WID_0 ),
        .probe39                    ( la0_TRIG ),
        .probe40                    ( la0_STATE ),
        .probe41                    ( la0_PATTERN ),
        .probe42                    ( la0_PATTERN_NUM ),
        .probe43                    ( la0_OUT_PATTERN ),
        .probe44                    ( la0_PATTERN_DONE ),
        .probe45                    ( la0_CURRENT_PATTERN ),
        .probe46                    ( la0_START ),
        .probe47                    ( la0_Timer_counter ),
        .probe48                    ( la0_WR_Counte ),
        .probe49                    ( la0_total_len ),
        .probe50                    ( la0_LOOP_N ),
        .probe51                    ( la0_lfsr1 ),
        .probe52                    ( la0_ERROR ),
        .probe53                    ( la0_ddr_rst_done ),
        .probe54                    ( la0_pause )
    );
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 5 ),
        .NUM_PROBE_OUT          ( 37 ),
        .UUID           ( 128'he9b2c206e95048e19ec384d9a4466007 ),
        .PROBE_IN0_WIDTH        ( 64 ),
        .PROBE_IN1_WIDTH        ( 64 ),
        .PROBE_IN2_WIDTH        ( 1 ),
        .PROBE_IN3_WIDTH        ( 32 ),
        ...
        .PROBE_OUT17_WIDTH      ( 8 ),
        .PROBE_OUT18_WIDTH      ( 8 ),
        .PROBE_OUT19_WIDTH      ( 32 ),
        .PROBE_OUT20_WIDTH      ( 32 ),
        .PROBE_OUT21_WIDTH      ( 32 ),
        .PROBE_OUT22_WIDTH      ( 32 ),
        .PROBE_OUT23_WIDTH      ( 32 ),
        .PROBE_OUT24_WIDTH      ( 32 ),
        .PROBE_OUT25_WIDTH      ( 32 ),
        .PROBE_OUT26_WIDTH      ( 32 ),
        .PROBE_OUT27_WIDTH      ( 32 ),
        .PROBE_OUT28_WIDTH      ( 32 ),
        .PROBE_OUT29_WIDTH      ( 32 ),
        .PROBE_OUT30_WIDTH      ( 32 ),
        .PROBE_OUT31_WIDTH      ( 32 ),
        .PROBE_OUT32_WIDTH      ( 32 ),
        .PROBE_OUT33_WIDTH      ( 32 ),
        .PROBE_OUT34_WIDTH      ( 32 ),
        .PROBE_OUT35_WIDTH      ( 1 ),
        .PROBE_OUT36_WIDTH      ( 1 ),
        .PROBE_OUT0_INIT_VAL    ( 'h0 ),
        .PROBE_OUT1_INIT_VAL    ( 'h3333 ),
        .PROBE_OUT2_INIT_VAL    ( 'hf ),
        .PROBE_OUT3_INIT_VAL    ( 'h1f ),
        .PROBE_OUT4_INIT_VAL    ( 'h1f ),
        .PROBE_OUT5_INIT_VAL    ( 'h1f ),
        .PROBE_OUT6_INIT_VAL    ( 'h1f ),
        .PROBE_OUT7_INIT_VAL    ( 'h1f ),
        .PROBE_OUT8_INIT_VAL    ( 'h1f ),
        .PROBE_OUT9_INIT_VAL    ( 'h1f ),
        .PROBE_OUT10_INIT_VAL   ( 'h1f ),
        .PROBE_OUT11_INIT_VAL   ( 'h1f ),
        .PROBE_OUT12_INIT_VAL   ( 'h1f ),
        .PROBE_OUT13_INIT_VAL   ( 'h1f ),
        .PROBE_OUT14_INIT_VAL   ( 'h1f ),
        .PROBE_OUT15_INIT_VAL   ( 'h1f ),
        .PROBE_OUT16_INIT_VAL   ( 'h1f ),
        .PROBE_OUT17_INIT_VAL   ( 'h1f ),
        .PROBE_OUT18_INIT_VAL   ( 'h1f ),
        .PROBE_OUT19_INIT_VAL   ( 'h0 ),
        .PROBE_OUT20_INIT_VAL   ( 'h400 ),
        .PROBE_OUT21_INIT_VAL   ( 'h0 ),
        .PROBE_OUT22_INIT_VAL   ( 'h400 ),
        .PROBE_OUT23_INIT_VAL   ( 'h0 ),
        .PROBE_OUT24_INIT_VAL   ( 'h400 ),
        .PROBE_OUT25_INIT_VAL   ( 'h0 ),
        .PROBE_OUT26_INIT_VAL   ( 'h400 ),
        .PROBE_OUT27_INIT_VAL   ( 'h0 ),
        .PROBE_OUT28_INIT_VAL   ( 'h400 ),
        .PROBE_OUT29_INIT_VAL   ( 'h0 ),
        .PROBE_OUT30_INIT_VAL   ( 'h400 ),
        .PROBE_OUT31_INIT_VAL   ( 'h0 ),
        .PROBE_OUT32_INIT_VAL   ( 'h400 ),
        .PROBE_OUT33_INIT_VAL   ( 'h0 ),
        .PROBE_OUT34_INIT_VAL   ( 'h400 ),
        .PROBE_OUT35_INIT_VAL   ( 'h0 ),
        .PROBE_OUT36_INIT_VAL   ( 'h0 )
    ) vio0 (
        .bscan_CAPTURE      ( bscan_CAPTURE ),
        .bscan_DRCK         ( bscan_DRCK    ),
        .bscan_RESET        ( bscan_RESET   ),
        ...
        .clk                ( vio0_clk ),
        .probe_in0          ( vio0_Total_ALEN ),
        .probe_in1          ( vio0_Cycle_Counter ),
        .probe_in2          ( vio0_Test_Done ),
        .probe_in3          ( vio0_Band_Width_MBs ),
        .probe_in4          ( vio0_ERROR ),
        .probe_in5          ( 1'b0 ),
        .probe_in6          ( 1'b0 ),
        .probe_in7          ( 1'b0 ),
        .probe_in8          ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio0_LOOP_N ),
        .probe_out1         ( vio0_PATTERN ),
        .probe_out2         ( vio0_PATTERN_DEPTH ),
        .probe_out3         ( vio0_PATTERN_LEN0 ),
        .probe_out4         ( vio0_PATTERN_LEN1 ),
        .probe_out5         ( vio0_PATTERN_LEN2 ),
        .probe_out6         ( vio0_PATTERN_LEN3 ),
        .probe_out7         ( vio0_PATTERN_LEN4 ),
        .probe_out8         ( vio0_PATTERN_LEN5 ),
        .probe_out9         ( vio0_PATTERN_LEN6 ),
        .probe_out10            ( vio0_PATTERN_LEN7 ),
        .probe_out11            ( vio0_PATTERN_LEN8 ),
        .probe_out12            ( vio0_PATTERN_LEN9 ),
        .probe_out13            ( vio0_PATTERN_LEN10 ),
        .probe_out14            ( vio0_PATTERN_LEN11 ),
        .probe_out15            ( vio0_PATTERN_LEN12 ),
        .probe_out16            ( vio0_PATTERN_LEN13 ),
        .probe_out17            ( vio0_PATTERN_LEN14 ),
        .probe_out18            ( vio0_PATTERN_LEN15 ),
        .probe_out19            ( vio0_PATTERN_ADDR0 ),
        .probe_out20            ( vio0_PATTERN_ADDR1 ),
        .probe_out21            ( vio0_PATTERN_ADDR2 ),
        .probe_out22            ( vio0_PATTERN_ADDR3 ),
        .probe_out23            ( vio0_PATTERN_ADDR4 ),
        .probe_out24            ( vio0_PATTERN_ADDR5 ),
        .probe_out25            ( vio0_PATTERN_ADDR6 ),
        .probe_out26            ( vio0_PATTERN_ADDR7 ),
        .probe_out27            ( vio0_PATTERN_ADDR8 ),
        .probe_out28            ( vio0_PATTERN_ADDR9 ),
        .probe_out29            ( vio0_PATTERN_ADDR10 ),
        .probe_out30            ( vio0_PATTERN_ADDR11 ),
        .probe_out31            ( vio0_PATTERN_ADDR12 ),
        .probe_out32            ( vio0_PATTERN_ADDR13 ),
        .probe_out33            ( vio0_PATTERN_ADDR14 ),
        .probe_out34            ( vio0_PATTERN_ADDR15 ),
        .probe_out35            ( vio0_Reset ),
        .probe_out36            ( vio0_Pause ),
        .probe_out37            (  ),
        .probe_out38            (  ),
        .probe_out39            (  ),
        .probe_out40            (  ),
