...
create_clock -period 10.000 -name clk_command [get_ports {clk_command}]
...
# set_clock_latency -source -setup <board_max + 3.698> [get_ports {clk_command}]
# set_clock_latency -source -hold <board_min + 2.074> [get_ports {clk_command}]
# set_clock_latency -source -setup <board_max + 3.698> [get_ports {clk50}]
# set_clock_latency -source -hold <board_min + 2.074> [get_ports {clk50}]
